                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-d57ea5b2db9832ed2a7cdcacec94f613"' : 'data-target="#xs-components-links-module-AppModule-d57ea5b2db9832ed2a7cdcacec94f613"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-d57ea5b2db9832ed2a7cdcacec94f613"' :
                                            'id="xs-components-links-module-AppModule-d57ea5b2db9832ed2a7cdcacec94f613"' }>
                                            <li class="link">
