                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-9600ccce469cd79e9da25ddc42fad74b"' : 'data-target="#xs-components-links-module-AppModule-9600ccce469cd79e9da25ddc42fad74b"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-9600ccce469cd79e9da25ddc42fad74b"' :
                                            'id="xs-components-links-module-AppModule-9600ccce469cd79e9da25ddc42fad74b"' }>
                                            <li class="link">
